...
export const GAMES: GameDef[] = [
  ...
  // --- PHASE 7: NINTENDO EXPANSION ---
  { id: 'ng11', title: 'Prompt Knight', description: 'Zelda-style Action RPG. Craft spells to defeat logic bugs.', type: GameType.PROMPT_KNIGHT, xpReward: 500, durationMin: 15, tags: [SkillType.PROMPTING, SkillType.SAFETY], difficulty: 'Pro', visualPrompt: 'Isometric pixel art dungeon heroic knight sword glowing' },
  { id: 'ng12', title: 'Data-Kart 2049', description: 'Cyberpunk Kart Racing. Optimize vector paths to drift.', type: GameType.DATA_KART, xpReward: 600, durationMin: 5, tags: [SkillType.ANALYSIS, SkillType.DEBUGGING], difficulty: 'Elite', visualPrompt: 'Neon racing kart drifting fast retro outrun synthwave' },
  { id: 'ng13', title: 'Agent Crossing', description: 'Animal Crossing-style Cozy Sim. Manage an isometric village of autonomous AI agents.', type: GameType.AGENT_CROSSING, xpReward: 800, durationMin: 20, tags: [SkillType.ANALYSIS, SkillType.CREATIVITY], difficulty: 'Rookie', visualPrompt: 'Isometric cute animal crossing village with robot villagers' },
  { id: 'ng14', title: 'Super ML Bros', description: 'Classic 2D Platformer. Use LLM parameter powerups to jump through the latent space.', type: GameType.SUPER_ML_BROS, xpReward: 400, durationMin: 10, tags: [SkillType.PROMPTING, SkillType.DEBUGGING], difficulty: 'Pro', visualPrompt: 'Retro 8-bit mushroom platformer mixed with matrix glowing green code' },
  { id: 'ng15', title: 'Prompt-emon', description: 'Turn-Based RPG. Train your Models to defeat Legacy Code monsters in prompt battles.', type: GameType.PROMPT_EMON, xpReward: 700, durationMin: 15, tags: [SkillType.PROMPTING, SkillType.ETHICS], difficulty: 'Elite', visualPrompt: 'Anime style monster battle retro handheld game with futuristic code monsters' },
  { id: 'ng16', title: 'Token Tactics', description: 'Grid-based Strategy. Move specialized AI agents across a tactical grid to secure Data Nodes.', type: GameType.TOKEN_TACTICS, xpReward: 800, durationMin: 20, tags: [SkillType.ANALYSIS, SkillType.DEBUGGING], difficulty: 'Elite', visualPrompt: 'Isometric tactical grid game cyber neon agents' },
  { id: 'ng17', title: 'The Latent Space', description: 'Metroidvania. Unlock AI abilities like Vision and Audio to explore an interconnected map.', type: GameType.LATENT_SPACE, xpReward: 900, durationMin: 25, tags: [SkillType.ANALYSIS, SkillType.CREATIVITY], difficulty: 'Elite', visualPrompt: 'Metroidvania dark neon cyber pixel art labyrinth' },
  { id: 'ng18', title: 'Silicon Valley', description: 'Farming Sim. Plant, water, and grow server racks to harvest Tokens.', type: GameType.SILICON_VALLEY, xpReward: 400, durationMin: 15, tags: [SkillType.PLANNING, SkillType.ANALYSIS], difficulty: 'Rookie', visualPrompt: 'Top down farming simulator harvesting servers pixel art isometric stardew valley' },
  { id: 'ng19', title: 'Prompt Kitchen', description: 'Overcooked-style Time Management. Frantically combine System Prompts and Context to serve User Requests.', type: GameType.PROMPT_KITCHEN, xpReward: 600, durationMin: 10, tags: [SkillType.PROMPTING, SkillType.REASONING], difficulty: 'Pro', visualPrompt: 'Overcooked style chaotic kitchen top down with glowing blue AI ingredients and chaotic orders' },
  { id: 'ng20', title: 'Cyber-Smash', description: '2.5D Brawler. Fight using combos that represent different prompting techniques.', type: GameType.CYBER_SMASH, xpReward: 800, durationMin: 15, tags: [SkillType.PROMPTING, SkillType.DEBUGGING], difficulty: 'Elite', visualPrompt: 'Smash bros style fighting game 2.5d neon cyberpunk characters fighting' }
];
