...
export enum GameType {
  ...
  PROMPT_KNIGHT = 'PROMPT_KNIGHT',
  DATA_KART = 'DATA_KART',
  AGENT_CROSSING = 'AGENT_CROSSING',
  SUPER_ML_BROS = 'SUPER_ML_BROS',
  PROMPT_EMON = 'PROMPT_EMON',
  TOKEN_TACTICS = 'TOKEN_TACTICS',
  LATENT_SPACE = 'LATENT_SPACE',
  SILICON_VALLEY = 'SILICON_VALLEY',
  PROMPT_KITCHEN = 'PROMPT_KITCHEN',
  CYBER_SMASH = 'CYBER_SMASH'
}
