    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="w-full max-w-2xl bg-[#0f172a] border border-purple-500/30 rounded-2xl shadow-[0_0_50px_rgba(168,85,247,0.15)] overflow-hidden flex flex-col max-h-[80vh]">
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          {/* Sidebar Actions */}
          <div className="w-full md:w-64 border-b md:border-b-0 md:border-r border-white/5 bg-slate-900/50 p-4 space-y-2 overflow-y-auto max-h-[200px] md:max-h-none shrink-0">
